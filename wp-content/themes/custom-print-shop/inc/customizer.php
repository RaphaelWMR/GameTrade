...
function custom_print_shop_customize_register( $wp_customize ) {
	...
	//About Section
		...
		$wp_customize->add_control('custom_print_shop_demo_link',array(
			'type'=> 'hidden',
			'description' => "<h3>". esc_html('Theme Demo','custom-print-shop') ."</h3><p>". esc_html('Our premium version of Custom Print Shop has unlimited sections with advanced control fields. Dedicated support and no limititation in any field.','custom-print-shop') ."</p> <a target='_blank' href='". esc_url('https://themescaliber.com/demo/custom-print-shop-pro/') ." '>". esc_html('View Demo','custom-print-shop') ."</a>",
		...
		$wp_customize->add_control('custom_print_shop_doc_link',array(
			'type'=> 'hidden',
			'description' => "<h3>". esc_html('Theme Documentation','custom-print-shop') ."</h3><p>". esc_html('We have well prepared documentation that provides the general guidelines and suggestions needed for this theme.','custom-print-shop') ."</p> <a target='_blank' href='". esc_url('https://themescaliber.com/demo/doc/custom-print-shop/') ." '>". esc_html('View Documentation','custom-print-shop') ."</a>",
			'section'=> 'custom_print_shop_about_theme'
		));
		...
		$wp_customize->add_control('custom_print_shop_forum_link',array(
			'type'=> 'hidden',
			'description' => "<h3>". esc_html('Theme Support','custom-print-shop') ."</h3><p>". esc_html('Regarding any theme issue, we offer 24/7 support. You can get assistance from our support staff in resolving any problem. Please get in touch with us.','custom-print-shop') ."</p><a target='_blank' href='". esc_url('https://wordpress.org/support/theme/custom-print-shop/') ." '>". esc_html('Support Forum','custom-print-shop') ."</a>",
			'section'=> 'custom_print_shop_about_theme'
		));
    ...
    $wp_customize->add_control('custom_print_shop_menu_settings_premium_features', array(
    	'type'=> 'hidden',
        'description' => "<h3>". esc_html('More Features in the Premium Version!','custom-print-shop') ."</h3>
        	<ul>
        		<li>". esc_html('Menu Background Colors','custom-print-shop') ."</li>
        		<li>". esc_html('Menu Item Fonts','custom-print-shop') ."</li>
        		<li>". esc_html('Responsive Menu Colors','custom-print-shop') ."</li>
        		<li>". esc_html('Header Search Icons Colors','custom-print-shop') ."</li>
        		<li>". esc_html('... and Other Premium Features','custom-print-shop') ."</li>
        	</ul>
        	<a target='_blank' href='". esc_url('https://www.themescaliber.com/themes/print-on-demand-wordpress-theme/') ." '>". esc_html('Upgrade Now','custom-print-shop') ."</a>",
        'section' => 'custom_print_shop_header'
        )
    );
   ...
   $wp_customize->add_setting('custom_print_shop_tagline_title',array(
    ...
    $wp_customize->add_control('custom_print_shop_featured_settings_premium_features', array(
        ...
        'description' => "<h3>". esc_html('More Features in the Premium Version!','custom-print-shop') ."</h3>
        	<ul>
        		<li>". esc_html('Section Background Image Option','custom-print-shop') ."</li>
        		<li>". esc_html('Choose Tab Icon Options','custom-print-shop') ."</li>
        		<li>". esc_html('... and Other Premium Features','custom-print-shop') ."</li>
        	</ul>
        	<a target='_blank' href='". esc_url('https://www.themescaliber.com/themes/print-on-demand-wordpress-theme/') ." '>". esc_html('Upgrade Now','custom-print-shop') ."</a>",
        'section' => 'custom_print_shop_featured_tour_section'
    ...
    $wp_customize->add_control('custom_print_shop_post_settings_premium_features', array(
        ...
        'description' => "<h3>". esc_html('More Features in the Premium Version!','custom-print-shop') ."</h3>
        	<ul>
        		<li>". esc_html('Section Heading Option','custom-print-shop') ."</li>
        		<li>". esc_html('Animated Elements Colors','custom-print-shop') ."</li>
        		<li>". esc_html('... and Other Premium Features','custom-print-shop') ."</li>
        	</ul>
        	<a target='_blank' href='". esc_url('https://www.themescaliber.com/themes/print-on-demand-wordpress-theme/') ." '>". esc_html('Upgrade Now','custom-print-shop') ."</a>",
        'section' => 'custom_print_shop_blog_post'
    ...
    // text trasform
	$wp_customize->add_setting('custom_print_shop_footer_text_transform',array(
		'default'=> 'Capitalize',
		'sanitize_callback'	=> 'custom_print_shop_sanitize_choices'
	));
	$wp_customize->add_control('custom_print_shop_footer_text_transform',array(
		'type' => 'radio',
		'label'	=> __('Heading Text Transform','custom-print-shop'),
		'section'=> 'custom_print_shop_footer_section',
		'choices' => array(
	      'Uppercase' => __('Uppercase','custom-print-shop'),
	      'Capitalize' => __('Capitalize','custom-print-shop'),
