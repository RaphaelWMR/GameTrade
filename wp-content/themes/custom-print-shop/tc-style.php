<?php 
	...
	$custom_print_shop_theme_lay = get_theme_mod( 'custom_print_shop_footer_text_transform','Capitalize');
		if($custom_print_shop_theme_lay == 'Capitalize'){
			$custom_print_shop_custom_css .='.footertown .widget h3, a.rsswidget.rss-widget-title{';
				$custom_print_shop_custom_css .='text-transform:Capitalize;';
			$custom_print_shop_custom_css .='}';
		}
		if($custom_print_shop_theme_lay == 'Lowercase'){
			$custom_print_shop_custom_css .='.footertown .widget h3, a.rsswidget.rss-widget-title{';
				$custom_print_shop_custom_css .='text-transform:Lowercase;';
			$custom_print_shop_custom_css .='}';
		}
		if($custom_print_shop_theme_lay == 'Uppercase'){
			$custom_print_shop_custom_css .='.footertown .widget h3, a.rsswidget.rss-widget-title{';
				$custom_print_shop_custom_css .='text-transform:Uppercase;';
			$custom_print_shop_custom_css .='}';
		}
